...
- api.yaml / async-api.yaml (derivados de service-contract.cue; formato imposto por spec externa: OpenAPI, AsyncAPI)
...
│       │   # ── Contratos e Tipos ──
│       │
│       ├── service-contract.cue           # SoT autoral — superfície síncrona e assíncrona do BC
│       ├── api.yaml                     # OpenAPI — derivado de service-contract.cue (gerado)
│       ├── async-api.yaml               # AsyncAPI — derivado de service-contract.cue (gerado)
│       ├── schemas/
...
| 9 | Contratos e Tipos | contexts/{bc-code}/service-contract.cue (source of truth), schemas/*.cue, api.yaml e async-api.yaml (derivados) |
...
- [ ] service-contract.cue com superfícies sync/async alinhadas ao canvas. api.yaml e async-api.yaml derivados quando generator existir.
