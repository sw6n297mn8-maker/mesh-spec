...
//
// Os tipos (#DesignPrinciple, #PrincipleGroup) e o _schema.location foram
// movidos para architecture/artifact-schemas/design-principles.cue
// (schematização per adr-090 follow-on / adr-093). Refactor content-preserving:
// o conteúdo dos 13 princípios permanece inalterado; apenas a instância passa
// a conformar ao schema #DesignPrinciples e o campo top-level passa de
// `principles` para `designPrinciples` (espelha domain-definition).

designPrinciples: artifact_schemas.#DesignPrinciples & {
	principles: {
		// ═══════════════════════════════════════════
		// Foundation (P0–P2) — Axiomas inegociáveis do sistema.
		// ═══════════════════════════════════════════
		P0: {
			group: "Foundation"
			statement: """
		...
		// ═══════════════════════════════════════════
		// Structural Invariants (P3–P6) — Propriedades que devem valer sempre.
		// ═══════════════════════════════════════════
		P3: {
		...
		// ═══════════════════════════════════════════
		// Design Philosophy (P7–P9) — Guiam como construímos.
		// ═══════════════════════════════════════════
		P7: {
		...
		// ═══════════════════════════════════════════
		// System Nature (P10–P11) — Que tipo de sistema a Mesh é.
		// ═══════════════════════════════════════════
		P10: {
			group: "SystemNature"
			statement: """
