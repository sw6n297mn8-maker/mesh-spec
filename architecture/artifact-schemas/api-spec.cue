...
// condicionada a flags do canvas) foram codificadas na convenção
// api-spec-convention.cue (architecture/conventions/, WI-027 B.1,
// adr-048) e são enforçadas via structural-check dedicado
// (sc-cv-02/sc-cv-03 em architecture/structural-checks/canvas.cue,
// WI-027 B.2, adr-049).
//
...
//    de presença é enforçada pelo structural-check da convenção
//    (sc-cv-02/sc-cv-03), não pelo mecanismo genérico de classification.
//    Gap de inventário registrado em ten-010.
//
...
//    padrão externo é responsabilidade da convenção e do enforcement
//    futuro específico ao padrão, não deste schema.
//
// 3. Bloqueador mecânico do enum #ArtifactType resolvido por adr-047
//    (extensão com openapi-spec e asyncapi-spec, B.0 de WI-027).
