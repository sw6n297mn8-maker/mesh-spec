...
def044: artifact_schemas.#DeferredDecision & {
	...
	description: """
		adr-141 fixa o contrato do DeliveryPort — o Port de transporte durável, NÃO-SoT (categoria:
		broker com lease/ack/redelivery): operações, PortResult<T>, value classes na fronteira,
		obrigações de contract-test. Fica deferida a seleção do vendor de broker que IMPLEMENTA esse
