	...
	"sc-meta-02": artifact_schemas.#StructuralCheck & {
		...
		rule: {
			...
			exemptTypes: [
				...
				{type: "economic-mechanism-model", rationale: "(def-002) mechanisms[] têm campos enforces/protectsAgainst cuja semântica de ref (princípios? invariantes?) precisa investigação antes de autorar — não é ref id-direta óbvia. Sub-pass futuro."},
