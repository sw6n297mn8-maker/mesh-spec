	...
	"sc-meta-02": artifact_schemas.#StructuralCheck & {
		...
		rule: {
			...
			exemptTypes: [
				...
				{type: "directory-meta", rationale: "(P) Metadata de diretório em _meta.cue (adr-115); consistência (canonicalPath==path real, 20-200 runes, sync da árvore derivada) guardada pelo gerador determinístico generate-repo-tree.py + gate de órfão, não por structural-check próprio. Simétrico ao readme-config."},
