...
// adr-104: todo domain-model.events[].name é PascalCase sem espaços. Born-warn:
// hoje dispara nos ~22 names ainda não-normalizados (rew com parentéticos,
// dlv/inv com espaços) — inventário de normalização. Promove a reject após a
// normalização dos 22 (sub-pass futuro).
...
structuralChecks: "sc-ev-01": artifact_schemas.#StructuralCheck & {
	...
	rationale:    "adr-107: name é a chave cross-artifact de event (adr-104); um vocabulário só é referenciável de forma confiável se a convenção de formato for consistente. Born-warn surface os names ainda não-normalizados; promoção a reject após a normalização."
	enforcement: "warn"
}
