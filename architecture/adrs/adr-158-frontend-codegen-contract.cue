...
adr158: artifact_schemas.#ADR & {
	...
	context: """
		...
		do adr-155). A hipótese ainda NÃO validada é só o ALVO — CUE→TS, não CUE→Kotlin —,
	...
	decision: """
		...
		SEM fixar a forma TS = runtime); output (livesIn: frontend-runtime,
	...
	falsificationCondition: {
		condition: """
			...
			superfície FCE e ela NÃO compilar em TS — a hipótese CUE→TS falsa (mantém proposed,
			...
			fronteira vazar — o contrato fixar a forma TS (COMO) que devia ser runtime-local.
			"""
		observableSignal: """
