...
artifact_schemas.#AnalyticalLens & {
	...
	purpose: "Avaliar se regras que governam interação econômica entre participantes da Mesh — scoring, pricing, alocação, disclosure — produzem incentivos alinhados sob condições realistas, cobrindo desde design analítico clássico até iteração data-driven."
	...
	meshExamples: [
		{
			...
			assumptions: [
				"fornecedores conseguem fragmentar entregas operacionalmente sem custo proibitivo — verificar com dados reais de pedidos",
				"scoring ponderado por valor é computacionalmente viável com dados disponíveis na plataforma",
			]
		...
		},
		{
			...
			assumptions: [
				"volume de transações é suficiente para análise estatística de padrões — no bootstrap, detecção depende de revisão manual",
				"dados financeiros cruzados (pagamento vs nota fiscal) estão disponíveis na Mesh para verificação",
				"threshold de concentração para escalar análise jurídica está definido ou será calibrado com jurídico",
			]
