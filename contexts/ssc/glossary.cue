...
glossary: artifact_schemas.#Glossary & {
	...
	terms: [{
		...
		relatedTerms: ["term-fitness-rules", "term-categoria-de-compra", "term-sourcing-decision", "term-mapa-de-cotacoes"]
	}, {
		...
		antiTerms: [{
			...
			clarification: "O mapa é o instrumento da COMPARAÇÃO (pré-decisão, indicativo); a decisão é o ato formal que o gestor/comprador toma sobre ele (cmd-make-*-decision, com rationale e snapshot). O mapa suporta a escolha; a decisão a consuma."
		}, {
			term:          "Equalização TCO"
			clarification: "A equalização é o PADRÃO ANALÍTICO (a normalização); o mapa é a SUPERFÍCIE consultável que a apresenta lado a lado. O mapa deriva da equalização — não a redefine (a lógica vive em FitnessRuleContent, configuração versionada)."
		}]
		relatedTerms: ["term-equalizacao-tco", "term-rfq", "term-fitness-rules", "term-decision-rationale"]
	}, {
