...
taskSpecs: "WI-081": {
	version:     1
	title:       "Criar structural-check de invariantes de dominio do BC SSC (ssc-domain-model.cue)"
	...
	semanticPrerequisites: [
		...
		"contexts/ssc/domain-model.cue — invariantes do BC SSC que os checks codificam",
	]
	outputs: [{
		artifact: "architecture/structural-checks/ssc-domain-model.cue"
		type:     "create"
	}]
	affects: []
	rationale: """
		Backfill retroativo per sc-wg-01: a autoria dos structural-checks de
		invariantes de dominio do BC SSC foi proposta, aprovada, reivindicada e
		concluida em 2026-05-12 (work-events/wi-081.cue), mas a task-spec pareada
		...
		codificando os invariantes do domain-model do SSC como gates deterministicos
