...
taskSpecs: "WI-082": {
	version:     1
	title:       "Criar structural-check de invariantes de dominio do BC CTR (ctr-domain-model.cue)"
	...
	semanticPrerequisites: [
		...
		"contexts/ctr/domain-model.cue — invariantes do BC CTR que os checks codificam",
	]
	outputs: [{
		artifact: "architecture/structural-checks/ctr-domain-model.cue"
		type:     "create"
	}]
	affects: []
	rationale: """
		Backfill retroativo per sc-wg-01: a autoria dos structural-checks de
		invariantes de dominio do BC CTR foi proposta, aprovada, reivindicada e
		concluida em 2026-05-12 (work-events/wi-082.cue), mas a task-spec pareada
		...
		codificando os invariantes do domain-model do CTR como gates deterministicos
