...
ntf_canvas_deletion: build_time.#SelfReviewReport & {
	reportId: "srr-ntf-canvas-deletion"
	...
	deletionContext: "Removido no reset corretivo (PR #43): BC NTF descontinuado; canvas deletado junto com o contexto. Strategic intent preservado em strategic/subdomains/ntf.cue."
	...
	summary: """
		Deletion-only SRR para contexts/ntf/canvas.cue. Artifact apagado durante reset
