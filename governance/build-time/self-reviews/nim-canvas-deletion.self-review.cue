...
nim_canvas_deletion: build_time.#SelfReviewReport & {
	reportId: "srr-nim-canvas-deletion"

	artifactPath:       "contexts/nim/canvas.cue"
	artifactSchemaPath: "architecture/artifact-schemas/canvas.cue"
	artifactType:       "canvas"

	recordType:      "artifact-deletion"
	deletionContext: "Removido no reset corretivo (PR #43): BC NIM descontinuado; canvas deletado junto com o contexto. Strategic intent preservado em strategic/subdomains/nim.cue."
	...
	roundDetails: [{
		...
		summary: """
			...
			Strategic intent em strategic/subdomains/nim.cue preservado
	...
	summary: """
		Deletion-only SRR para contexts/nim/canvas.cue. Artifact apagado durante reset
		Phase por contaminação por escalada semântica. Strategic intent
		preservado em strategic/subdomains/nim.cue. Decisão de design
