...
adr040C3Part3Migration: build_time.#SelfReviewReport & {
	reportId: "srr-adr-040-c3-part3-migration"
	...
	roundDetails: [{
		...
		warnCount: 0
		infoCount: 0
		summary:   "C3 Part 3 migration per adr-059: 1 path reclassificado de affectedArtifacts (existing-altered) para plannedOutputs (new-created): architecture/tension-log/ten-006-validation-non-determinism.cue. 2 paths permanecem em affectedArtifacts (governance/build-time/quality-gate.cue, CLAUDE.md). Verified via git archaeology (commit hash + timestamp comparison vs ADR commit). Editorial migration."
	}]
