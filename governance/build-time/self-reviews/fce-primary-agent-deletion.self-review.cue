...
fce_primary_agent_deletion: build_time.#SelfReviewReport & {
	reportId: "srr-fce-primary-agent-deletion"
	...
	deletionContext: "Removido no reset corretivo (PR #43): BC FCE descontinuado; primary-agent deletado junto com o contexto. Strategic intent preservado em strategic/subdomains/fce.cue."
	...
	summary: """
		Deletion-only SRR para contexts/fce/agents/fce-primary-agent.cue. Artifact apagado durante reset
