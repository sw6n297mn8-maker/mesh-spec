...
adr003C3Part3Migration: build_time.#SelfReviewReport & {
	reportId: "srr-adr-003-c3-part3-migration"

	artifactPath:       "architecture/adrs/adr-003-typed-adrs-with-ci-enforcement.cue"
	...
	roundDetails: [{
		...
		warnCount: 0
		infoCount: 0
		summary:   "C3 Part 3 migration per adr-059: 1 path reclassificado de affectedArtifacts (existing-altered) para plannedOutputs (new-created): architecture/artifact-schemas/adr.cue. 2 paths permanecem em affectedArtifacts (governance/repo-structure.cue, CLAUDE.md). Verified via git archaeology (commit hash + timestamp comparison vs ADR commit). Editorial migration."
	}]
