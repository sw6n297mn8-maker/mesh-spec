...
fce_canvas_deletion: build_time.#SelfReviewReport & {
	reportId: "srr-fce-canvas-deletion"
	...
	summary: """
		Deletion-only SRR para contexts/fce/canvas.cue. Artifact apagado durante reset
