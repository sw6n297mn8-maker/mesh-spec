...
ntf_glossary_deletion: build_time.#SelfReviewReport & {
	reportId: "srr-ntf-glossary-deletion"
	...
	summary: """
		Deletion-only SRR para contexts/ntf/glossary.cue. Artifact apagado durante reset
