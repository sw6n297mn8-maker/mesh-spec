...
adr038C3Part3Migration: build_time.#SelfReviewReport & {
	reportId: "srr-adr-038-c3-part3-migration"
	...
	roundDetails: [{
		...
		warnCount: 0
		infoCount: 0
		summary:   "C3 Part 3 migration per adr-059: 1 path reclassificado de affectedArtifacts (existing-altered) para plannedOutputs (new-created): architecture/artifact-schemas/tension-entry.cue. 1 path permanecem em affectedArtifacts (architecture/artifact-schemas/quality-criteria.cue). Verified via git archaeology (commit hash + timestamp comparison vs ADR commit). Editorial migration."
	}]
