...
nim_glossary_deletion: build_time.#SelfReviewReport & {
	reportId: "srr-nim-glossary-deletion"
	...
	deletionContext: "Removido no reset corretivo (PR #43): BC NIM descontinuado; glossary deletado junto com o contexto. Strategic intent preservado em strategic/subdomains/nim.cue."
	...
	summary: """
		Deletion-only SRR para contexts/nim/glossary.cue. Artifact apagado durante reset
