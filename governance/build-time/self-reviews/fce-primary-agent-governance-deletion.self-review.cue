...
fce_primary_agent_governance_deletion: build_time.#SelfReviewReport & {
	reportId: "srr-fce-primary-agent-governance-deletion"
	...
	deletionContext: "Removido no reset corretivo (PR #43): BC FCE descontinuado; envelope de governanca do primary-agent deletado junto com o contexto. Strategic intent preservado em strategic/subdomains/fce.cue."
	...
	roundDetails: [{
		...
		summary: """
			...
			Strategic intent em strategic/subdomains/fce.cue preservado
	...
	summary: """
		Deletion-only SRR para contexts/fce/agents/fce-primary-agent.governance.cue. Artifact apagado durante reset
		Phase por contaminação por escalada semântica. Strategic intent
		preservado em strategic/subdomains/fce.cue. Decisão de design
