...
ntf_primary_agent_deletion: build_time.#SelfReviewReport & {
	reportId: "srr-ntf-primary-agent-deletion"
	...
	summary: """
		Deletion-only SRR para contexts/ntf/agents/ntf-primary-agent.cue. Artifact apagado durante reset
