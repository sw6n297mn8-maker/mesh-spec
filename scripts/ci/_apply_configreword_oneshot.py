...
EDITS = [
    ...
    ("notificados de deprecação — vivem em %sarchitecture/event-evolution.cue%s." % (BT, BT),
     "notificados de deprecação — serão definidas nas regras globais de evolução de eventos (planejado)."),
